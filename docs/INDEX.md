...
| [`design/`](design/) | 仕様・設計の正本。[キーボード表示](design/keyboard-layout-display.md) / [Vial 連携](design/vial-integration.md) / [展示画面と SCROLL LAB](design/scroll-lab-stage.md) | 実装に合わせて更新する |
