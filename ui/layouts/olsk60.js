...
const OLSK60_GEOMETRY = {
  ...
  keys: [
    // ---- Row 0 -------------------------------------------------
    { code: "Escape",         label: "Esc", m: [0, 0] },
    { code: "Digit1",         label: "1", shift: "!", m: [0, 1] },
    { code: "Digit2",         label: "2", shift: "@", m: [0, 2] },
    { code: "Digit3",         label: "3", shift: "#", m: [0, 3] },
    { code: "Digit4",         label: "4", shift: "$", m: [0, 4] },
    { code: "Digit5",         label: "5", shift: "%", m: [0, 5] },
    { code: "Digit6",         label: "6", shift: "^", m: [0, 6] },
    { code: "Digit7",         label: "7", shift: "&", m: [0, 7] },
    { code: "Digit8",         label: "8", shift: "*", m: [0, 8] },
    { code: "Digit9",         label: "9", shift: "(", m: [0, 9] },
    { code: "Digit0",         label: "0", shift: ")", m: [0, 10] },
    { code: "Backspace",      label: "Backspace", m: [0, 11] },
    // ---- Row 1 -------------------------------------------------
    { code: "Tab",            label: "Tab", m: [1, 0] },
    { code: "KeyQ",           label: "Q", m: [1, 1] },
    { code: "KeyW",           label: "W", m: [1, 2] },
    { code: "KeyE",           label: "E", m: [1, 3] },
    { code: "KeyR",           label: "R", m: [1, 4] },
    { code: "KeyT",           label: "T", m: [1, 5] },
    { code: "KeyY",           label: "Y", m: [1, 6] },
    { code: "KeyU",           label: "U", m: [1, 7] },
    { code: "KeyI",           label: "I", m: [1, 8] },
    { code: "KeyO",           label: "O", m: [1, 9] },
    { code: "KeyP",           label: "P", m: [1, 10] },
    { code: "BracketLeft",    label: "[", shift: "{", m: [1, 11] },
    { code: "Backslash",      label: "\\", shift: "|", m: [1, 12] },
    // ---- Row 2 -------------------------------------------------
    { code: "ControlLeft",    label: "Ctrl", id: "ControlLeft-home", m: [2, 0] },
    { code: "KeyA",           label: "A", m: [2, 1] },
    { code: "KeyS",           label: "S", m: [2, 2] },
    { code: "KeyD",           label: "D", m: [2, 3] },
    { code: "KeyF",           label: "F", homing: true, m: [2, 4] },
    { code: "KeyG",           label: "G", m: [2, 5] },
    { code: "KeyH",           label: "H", m: [2, 6] },
    { code: "KeyJ",           label: "J", homing: true, m: [2, 7] },
    { code: "KeyK",           label: "K", m: [2, 8] },
    { code: "KeyL",           label: "L", m: [2, 9] },
    { code: "Semicolon",      label: ";", shift: ":", m: [2, 10] },
    { code: "Enter",          label: "Enter", m: [2, 11] },
    // ---- Row 3 -------------------------------------------------
    { code: "ShiftLeft",      label: "Shift", m: [3, 0] },
    { code: "KeyZ",           label: "Z", m: [3, 1] },
    { code: "KeyX",           label: "X", m: [3, 2] },
    { code: "KeyC",           label: "C", m: [3, 3] },
    { code: "KeyV",           label: "V", m: [3, 4] },
    { code: "KeyB",           label: "B", m: [3, 5] },
    { code: "KeyN",           label: "N", m: [3, 6] },
    { code: "KeyM",           label: "M", m: [3, 7] },
    { code: "Comma",          label: ",", shift: "<", m: [3, 8] },
    { code: "Period",         label: ".", shift: ">", m: [3, 9] },
    { code: "Slash",          label: "/", shift: "?", m: [3, 10] },
    { code: "ArrowUp",        label: "↑", m: [3, 11] },
    { code: "ShiftRight",     label: "Shift", m: [3, 12] },
    // ---- Row 4 -------------------------------------------------
    { code: "ControlLeft",    label: "Ctrl", id: "ControlLeft-bottom", m: [4, 0] },
    { code: "MetaLeft",       label: "Win", win: true, m: [4, 1] },
    { code: "AltLeft",        label: "Alt", m: [4, 2] },
    { code: "Space",          label: "Space", m: [4, 4] },
    { code: "__Fn1",          label: "Fn1", layer: true, m: [4, 5] },
    { code: "Delete",         label: "Delete", m: [4, 7] },
    { code: "__Fn2",          label: "Fn2", layer: true, m: [4, 9] },
    { code: "ArrowLeft",      label: "←", m: [4, 10] },
    { code: "ArrowDown",      label: "↓", m: [4, 11] },
    { code: "ArrowRight",     label: "→", m: [4, 12] },
  ],
  phrases: [
    "hello olsk60",
